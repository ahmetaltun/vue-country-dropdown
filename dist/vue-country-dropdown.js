(function (global, factory) {
  ...
  */
  ...
  if (FORCED$1 || !hasOwn$2(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
  ...
  $$6({ global: true, constructor: true, forced: FORCED$1 }, {
  ...
  var IteratorProxy$1 = createIteratorProxy$1(function () {
    ...
    while (true) {
      result = anObject$6(call$4(next, iterator));
  ...
  $$5({ target: 'Iterator', proto: true, real: true, forced: IS_PURE$2 }, {
  ...
  var getIterator$1 = function (argument, usingIterator) {
    ...
    if (aCallable$3(iteratorMethod)) return anObject$5(call$3(iteratorMethod, argument));
  ...
  var calledWithNew = function (dummy) {
    ...
    return isPrototypeOf$1(NumberPrototype, dummy) && fails$1(function () { thisNumberValue(dummy); });
  };
  ...
  var script = {
    ...
    computed: {
      filteredCountries: function filteredCountries() {
        ...
        if (!this.showNotSelectedOption) {
          ...
          allCountries$1.shift();
        } else if (this.notSelectedOptionText !== "") {
          allCountries$1[0].name = this.notSelectedOptionText;
        }
    ...
    watch: {
      ...
      defaultCountryByAreaCode: function defaultCountryByAreaCode(newVal) {
        // check param typei can be string like "TR" or area code like 90
        var defaultCountry = this.findCountryByAreaCode(newVal);
        this.choose(defaultCountry);
      }
    },
    methods: {
      initializeCountry: function initializeCountry() {
        ...
        if (this.defaultCountryByAreaCode) {
          var defaultCountryByAreaCode = this.findCountryByAreaCode(this.defaultCountryByAreaCode);
      ...
      findCountryByAreaCode: function findCountryByAreaCode() {
        var areaCode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
        return allCountries$1.find(function (country) {
          return country.dialCode === areaCode.toString();
        });
      },
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c("div", {
      ...
      class: _vm.activeCountry && _vm.activeCountry.iso2 ? _vm.activeCountry.iso2.toLowerCase() : null
    }) : _vm._e(), _vm._v(" "), _vm.enabledCountryCode ? _c("span", {
      staticClass: "country-code",
      style: {
        width: _vm.showNameInput ? "auto" : "100%"
      },
      domProps: {
        textContent: _vm._s(_vm.activeCountry && _vm.activeCountry.dialCode ? " +" + _vm.activeCountry.dialCode : null)
      }
    }) : _vm._e(), _vm._v(" "), _vm.showNameInput ? _c("span", {
      staticClass: "country-name",
      style: {
        width: _vm.showNameInput ? "100%" : "auto"
      }
    }, [_vm._v("\n        " + _vm._s(_vm.activeCountry && _vm.activeCountry.name ? _vm.activeCountry.name : null) + "\n      ")]) : _vm._e(), _vm._v(" "), _c("span", {
      ...
      return _c("li", {
        ...
        domProps: {
          textContent: _vm._s(pb.name)
        }
      }), _vm._v(" "), _vm.dropdownOptions && !_vm.dropdownOptions.disabledDialCode ? _c("span", {
        domProps: {
          textContent: _vm._s(pb.dialCode && " +" + pb.dialCode)
        }
      }) : _vm._e()]);
    }), 0)])]);
  };
